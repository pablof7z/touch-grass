---
name: gh-plan-pr
description: Publish GitHub planning pull requests for complex assigned work. Use when an agent receives implementation work that may need architecture/design review, rule or ADR analysis, a concise planning PR body, a detailed plan document, TTS-friendly narration, hosted GitHub Pages presentation, proceed/pause decisioning, or a "Ready to implement" follow-up comment before implementation.
---
...
Use this skill when assigned work may be complex enough to deserve a planning PR before implementation. The agent supplies judgment and structured plan content; `scripts/publish_plan_pr.py` handles publishing mechanics including generated narration, hosted plan pages, PR body creation, and follow-up comments.
...
The PR body generated by the script must stay concise and skimmable. Provide:
