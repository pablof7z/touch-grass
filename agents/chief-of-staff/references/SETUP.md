...
your runbooks and operating state live only on this machine and cannot follow
...
3. **Move existing home contents into the repo, mirroring the path:**
       ...
       # Copy everything real from {{HOME}} (runbooks/, references you
...
- Preserve, don't discard: migrate every real runbook and reference you have.
- The symlink is the *only* signal that setup is complete; nothing else marks it.
- After this, runbooks you capture live in the repo automatically and are
